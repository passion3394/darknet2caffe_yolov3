...
//YOLOV3
    ...
    if(5 == argc){
        ...
        printf("Input error: please input ./xx YOLOV3 [model_path] [weights_path]  [img_path] or ./xx YOLOV3_TINY [model1_path] [model2_path] [weights_path] [img_path]\n");
        return -1;
    }
    ...
    imwrite("caffe-yolov3_test.jpg", img);
